...
#. In the :guilabel:`Credentials` tab, click on :guilabel:`Create Webhook`.
...
.. tip::
   If you need to update the webhook (for example, after changing your domain), click
   :guilabel:`Update Webhook`. Odoo will create a new webhook with the updated configuration.
