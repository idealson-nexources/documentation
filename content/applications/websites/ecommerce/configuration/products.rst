...
:doc:`Product combinations </applications/sales/point_of_sale/products>` allow users to configure a
set of related products to buy as a bundle. To :ref:`configure combos <pos/products/combos/choices>`,
